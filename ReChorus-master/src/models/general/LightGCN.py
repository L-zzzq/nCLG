...
class LGCNEncoder(nn.Module):
	def __init__(self, user_count, item_count, emb_size, norm_adj, n_layers=3):
		...
		self.user_embedding = nn.Embedding(self.user_count, self.emb_size)
		self.item_embedding = nn.Embedding(self.item_count, self.emb_size)
		...
		# self.register_buffer('sparse_norm_adj', tmp_norm_adj)
	...
	def get_all_embeddings(self):
		...
		user_all = all_embeddings[:self.user_count, :]
		item_all = all_embeddings[self.user_count:, :]
